# Generated by Django 6.0.2 on 2026-02-09 14:23
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('pending', 'Pending'), ('paid', 'Paid'), ('overdue', 'Overdue'), ('defaulted', 'Defaulted')], default='pending', max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('transaction_type', models.CharField(choices=[('deposit', 'Deposit'), ('withdrawal', 'Withdrawal'), ('transfer', 'Transfer'), ('loan_disbursement', 'Loan Disbursement')], max_length=20)),
                ('amount', models.DecimalField(decimal_places=2, max_digits=12)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('request_type', models.CharField(choices=[('deposit', 'Deposit Money'), ('withdrawal', 'Withdraw Money'), ('account_issue', 'Account Issue'), ('loan_application', 'Loan Application'), ('other', 'Other')], max_length=20)),
                ...
                ('account', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='requests', to='bank.bankaccount')),
